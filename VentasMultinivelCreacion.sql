...
(
	"K_CODCATEGORIA" NUMBER(5) NOT NULL,    -- CÓDIGO SUBCATEGORÍA
	"N_NOMBRE" VARCHAR2(50 CHAR) NOT NULL,    -- NOMBRE DE LA SUBCATEGORÍA
	"O_DESCRIPCION" VARCHAR2(150 CHAR) NOT NULL,    -- DESCRIPCIÓN DE LA SUBCATEGORÍA
	"K_SUPERCATEGORIA" NUMBER(5) NULL
)
;
...
(
	...
	"V_PORCOMISION" NUMBER(1,3) NOT NULL    -- PORCENTAJE DE COMISIÓN QUE LE CORRESPONDE AL REPRESENTANTE DE VENTAS SEGÚN SU CLASIFICACIÓN
)
;
...
(
	"K_CODREPVENTAS" NUMBER(11) NULL,
	"K_CODCLIENTE" NUMBER(11) NULL,
	"F_FECHA_INICO" DATE NOT NULL,
...
(
	...
	"O_FORMA_PAGO" VARCHAR2(7) NOT NULL,
	"V_CALIFICACION" NUMBER(2,1) NULL,
	"V_COMISION" NUMBER(15,2) NOT NULL
)
;
...
CREATE INDEX "IXFK_CATEGORIA_CATEGOR02"   
 ON  "CATEGORIA" ("K_CODCATEGORIA") 
;

CREATE INDEX "IXFK_CATEGORIA_CATEGOR03"   
 ON  "CATEGORIA" ("K_CODCATEGORIA") 
;
...
ALTER TABLE  "PRECIO" 
 ADD CONSTRAINT "UQ_K_PRODUCTO_F_FECHA" UNIQUE ("K_PRODUCTO","F_FECHA") USING INDEX 
 USING INDEX
;
...
CREATE INDEX "IXFK_PRODUCTO_SUBCATEGORIA"   
 ON  "PRODUCTO" ("K_CATEGORIA") 
;
...
ALTER TABLE  "REPRESENTANTE_CLIENTE" 
 ADD CONSTRAINT "CH_FEHCA_INICIO" CHECK ()
;
...
ALTER TABLE  "REPRESENTANTE_CLIENTE" 
 ADD CONSTRAINT "FK_REPRESENTANTE_CLIENTE_VENTA"
	FOREIGN KEY ("K_CODVENTA") REFERENCES  "VENTA" ("K_CODVENTA")
;
