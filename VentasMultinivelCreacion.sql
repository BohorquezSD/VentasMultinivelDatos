...
(
	...
	"K_ID_REP_CLIENTE" NUMBER(11) NOT NULL,
	"IVA" NUMBER(7,2) NOT NULL,    -- Impuesto aplicado a la venta
)
;
...
ALTER TABLE  "REPRESENTANTE_CLIENTE" 
 ADD CONSTRAINT "CH_FECHA_INICIO" CHECK (F_FECHA_INICO < F_FECHA_FIN)
;
...
ALTER TABLE "REGION_REPRESENTANTE"
 ADD CONSTRAINT "FK_REPVENTA"
	FOREIGN KEY (K_REPVENTA)
;

ALTER TABLE "REGION_REPRESENTANTE"
 ADD CONSTRAINT "FK_CODREGION"
	FOREIGN KEY (K_CODREGION)
;
